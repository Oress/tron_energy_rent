...
public class ReferralProgramsSearchHandler {
    ...
    @MatchStates({
            ...
            @MatchState(state = States.ADMIN_MANAGE_REF_PROGRAM_ACTION_PROMPT_TX1_AMOUNT, callbackData = InlineMenuCallbacks.GO_BACK),
            @MatchState(state = States.ADMIN_MANAGE_REF_PROGRAM_ACTION_PROMPT_TX2_AMOUNT, callbackData = InlineMenuCallbacks.GO_BACK),
