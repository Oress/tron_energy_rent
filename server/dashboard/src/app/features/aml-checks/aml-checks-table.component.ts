...
import { AmlCheckRow, AmlChecksService } from '../../core/api';
...
export class AmlChecksTableComponent {
  private readonly amlChecksApi = inject(AmlChecksService);
  private readonly filterService = inject(DashboardFilterService);
  private readonly destroyRef = inject(DestroyRef);
  private requestSequence = 0;

  readonly rows = signal<AmlCheckRow[]>([]);
