...
export class BaseService {
    ...
    public configuration: NrgyrentDashboardConfiguration;
    public encoder: HttpParameterCodec;

    constructor(basePath?: string|string[], configuration?: NrgyrentDashboardConfiguration) {
        this.configuration = configuration || new NrgyrentDashboardConfiguration();
